...
remove_entire_poor_lineages <- function(data_sims_trees, rich_lineage_treshold, percentage_spec_to_remove, data_sims_G)
{
  ...
  simulated_tree_to_change_data <- data_sims_trees  # corrected from all_trees to data_sims_trees
...
remove_entire_poor_lineages(data_sims_trees, rich_lineage_treshold, percentage_spec_to_remove, Galapagos_sims_G)
